...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    setTimeout(function () {
      return (0, _video.onYouTubeIframeAPIReady)();
    }, 1500);
...
},{"./modules/form-validate/form":3,"./modules/swiper/init-swipers":9,"./modules/tabs/init-tabs":10,"./modules/video/video":12,"./utils/ios-vh-fix":14}],2:[function(require,module,exports){
"use strict";
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var SWIPERS = ['swiper--coach', 'swiper--feedback'];
...
var coachSlides = document.querySelector('.swiper--coach').querySelectorAll('.swiper__slide');
...
var TABLET = {
  ...
  feedback: {
    class: 'swiper--feedback',
    settings: FEEDBACKSETTINGS
  }
};
var findClassIndex = function findClassIndex(element) {
  element.classList.findIndex(function (item) {
    return item.includes('--coach');
  });
};
var initSwipers = function initSwipers() {
  ...
  var swipersArray = [];
  if (swipers.length) {
    var set = [_objectSpread(_objectSpread({}, SWIPERSETTINGS), COACHSETTINGS), _objectSpread(_objectSpread({}, SWIPERSETTINGS), FEEDBACKSETTINGS)];
...
},{"../../vendor/swiper-bundle":15}],10:[function(require,module,exports){
"use strict";
