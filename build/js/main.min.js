...
var slides = document.querySelectorAll('.swiper__slide');
...
var initSwipers = function initSwipers() {
  var coachSwiper = new _swiperBundle.default('.swiper--coach', {
  ...
  var feedbackSwiper = new _swiperBundle.default('.swiper--feedback', {
    wrapperClass: 'swiper__wrapper',
    slideClass: 'swiper__slide',
    direction: 'horizontal',
    slidesPerView: 1,
